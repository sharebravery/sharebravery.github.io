import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as e,o as i}from"./app-DMVMUeoW.js";const l={};function p(d,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="创建项目" tabindex="-1"><a class="header-anchor" href="#创建项目"><span>创建项目</span></a></h2><ul><li>使用 nest 脚手架来创建新项目</li></ul><p><code>nest new thousand-silk-mongo</code></p><h2 id="安装-swagger" tabindex="-1"><a class="header-anchor" href="#安装-swagger"><span>安装 swagger</span></a></h2><p>除了基本的爬取数据的功能，后面还要写几个接口来操作数据库的数据。swagger 必备，装上。</p><p><code>yarn add --save @nestjs/swagger</code></p><ul><li>main.ts</li></ul><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>import { NestFactory } from &#39;@nestjs/core&#39;;</span></span>
