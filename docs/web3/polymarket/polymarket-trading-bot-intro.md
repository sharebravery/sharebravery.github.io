---
title: Polymarket 量化交易实战（序）：从零开发跟单 Bot
...
预测市场最近热度起飞。作为程序员，参与一个市场最好的方式不是去”预测“结果，而是去**建设工具**。
...
![](https://raw.githubusercontent.com/sharebravery/post/post/src/20260124215133885.png)
