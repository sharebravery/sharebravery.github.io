...
很多人把风控理解成“限制盈利”。实盘里刚好相反，风控决定的是你有没有资格长期参与。

在这套系统里，风控不是最后一层补丁，而是每个 tick 的入口条件。  
数据不新鲜就不做，价格不合理就不做，仓位失衡就少做。

短期看会“错过机会”，长期看是在筛掉劣质交易。  
真正拉开差距的，往往不是你抓住了多少机会，而是你躲开了多少本不该做的单子。
